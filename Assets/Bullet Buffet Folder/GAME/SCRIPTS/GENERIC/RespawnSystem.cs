...
public class RespawnSystem : MonoBehaviour
{
    ...
    //private void Start()
    //{
    //    //Instantiate(prefabPlayer1, modo1v1spawn1.transform.position, modo1v1spawn1.transform.rotation);
    //    //Instantiate(prefabPlayer2, modo1v1spawn2.transform.position, modo1v1spawn2.transform.rotation);
